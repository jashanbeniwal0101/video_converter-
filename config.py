...
# Working directory for downloads / processing
...
# FFmpeg defaults
DEFAULT_CRF = int(os.getenv("DEFAULT_CRF", "23"))  # lower = better quality, larger size
DEFAULT_PRESET = os.getenv("DEFAULT_PRESET", "medium")  # ultrafast, fast, medium, slow
